...
import Group7652 from "../../assets/Group7652.png";
...
const Pools = () => {
  ...
  const [openDetails, setOpenDeatails] = useState(false);
  ...
  return (
    <Box mt={8}>
      ...
      >
        <Details handleClose={handleCloseDetails} />
      </Dialog>
                ...
                <TableRow key={index}>
                  <TableCell sx={{ color: "#fff" }}>
                    <Box display="flex" alignItems="center" gap={1}>
                      <Box component="img" src={Group7652} width={30} mt={1} />
